...
class NS_MC_Plugin {
		...
		if (isset($_POST[self::$prefix . '_nonce'])) {
			...
			if (! wp_verify_nonce($nonce, $nonce_key)) {
				...
				echo '<div class="wrap">
					...
					<h2>MailChimp Widget Settings</h2><p>' . __('What you\'re trying to do looks a little shady.') . '</p></div>';
	...
	public function get_admin_notices () {
		...
		$notice .= __('You\'ll need to set up the MailChimp signup widget plugin options before using it. ') . __('You can make your changes') . ' <a href="/wp-admin/options-general.php?page=mailchimp_widget/lib/ns_mc_plugin.class.php">' . __('here') . '.</a>';
